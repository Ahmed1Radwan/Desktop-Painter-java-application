...
public class MainController {
	...
	private shapesPanel shapesCreationPanel;
	...
	private ListOfShapeNames namesList;
	...
	public MainController(myDrawingEngine engine, drawShape factory, GUI Paint) {
		this.engine = engine;
	...
	public class ShapeCreationBtnListner implements ActionListener {
		...
		@Override
		public void actionPerformed(ActionEvent e) {
			shapesBox source = (shapesBox) e.getSource();
	...
	class addPluginListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			shapesCreationPanel.updateShapesPanel(engine.getSupportedShapes());
			shapesCreationPanel.addButtonsListeners(new ShapeCreationBtnListner());
		}
	}
	...
	class UserGuideListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			try {
			    Desktop.getDesktop().browse(new URL("https://docs.google.com/document/d/1xXVqkwa0Kn37Pn-sIjJh6Rx6YSqVI9xfkupSrwXiroY/edit?usp=sharing").toURI());
